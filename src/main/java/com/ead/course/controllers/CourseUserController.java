...
public class CourseUserController {
    ...
    // É Object porque retorna mais de um tipo de retorno
    ...
    public ResponseEntity<Object> saveSubscriptionUserInCourse (@PathVariable(value = "courseId") UUID courseId,
        ...
        // usuário com essa inscrição já existe
        ...
        CourseUserModel courseUserModel = this.courseUserService.saveAndSendSubscriptionUserInCourse(courseModelOptional.get()
